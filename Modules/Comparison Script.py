...
##########################################################################################
# This script will take an excel with parameters found by discovery agent (CyberX/MDE Network Detection and Response)
# Because of the Sensitivity of the data, No example file will be provided.
##########################################################################################
